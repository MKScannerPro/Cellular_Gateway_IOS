...
@interface MKCKFilterByURLController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKFilterByURLModel *dataModel;

@end

@implementation MKCKFilterByURLController

- (void)dealloc {
    NSLog(@"MKCKFilterByURLController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKFilterByURLController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKFilterByURLModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKFilterByURLModel alloc] init];
    }
    return _dataModel;
}
