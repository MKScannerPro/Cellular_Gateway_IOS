//
//  MKCKFilterByNanoBeaconController.m
...
@interface MKCKFilterByNanoBeaconController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKFilterByNanoBeaconModel *dataModel;

@end

@implementation MKCKFilterByNanoBeaconController

- (void)dealloc {
    NSLog(@"MKCKFilterByNanoBeaconController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKFilterByNanoBeaconController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKFilterByNanoBeaconModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKFilterByNanoBeaconModel alloc] init];
    }
    return _dataModel;
}
