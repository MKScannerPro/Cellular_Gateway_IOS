//
//  MKCKFilterByBXPTagController.m
...
@interface MKCKFilterByBXPTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKFilterByBXPTagModel *dataModel;

@end

@implementation MKCKFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKCKFilterByBXPTagController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKFilterByBXPTagController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKFilterByBXPTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKFilterByBXPTagModel alloc] init];
    }
    return _dataModel;
}
