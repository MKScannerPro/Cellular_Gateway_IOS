//
//  MKCKFilterByBeaconController.m
...
@interface MKCKFilterByBeaconController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKFilterByBeaconModel *dataModel;

@end

@implementation MKCKFilterByBeaconController

- (void)dealloc {
    NSLog(@"MKCKFilterByBeaconController销毁");
}
...
- (void)loadSection0Datas {
    ...
    }else if (self.pageType == mk_ck_filterByBeaconPageType_bxpBeacon) {
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKFilterByBeaconController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKFilterByBeaconModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKFilterByBeaconModel alloc] init];
