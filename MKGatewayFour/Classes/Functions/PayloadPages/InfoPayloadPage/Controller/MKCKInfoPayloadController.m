...
@interface MKCKInfoPayloadController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKInfoPayloadModel *dataModel;

@end

@implementation MKCKInfoPayloadController

- (void)dealloc {
    NSLog(@"MKCKInfoPayloadController销毁");
}
...
- (void)mk_textSwitchCellStatusChanged:(BOOL)isOn index:(NSInteger)index {
    ...
    if (index == 6) {
        //Device property indicator
        self.dataModel.devicePropertyIndicator = isOn;
    ...
    if (index == 7) {
        ...
        self.dataModel.switchStatusIndicator = isOn;
...
- (void)loadSection1Datas {
    ...
    cellModel4.isOn = self.dataModel.voltage;
    [self.section1List addObject:cellModel4];
    
    MKTextSwitchCellModel *cellModel5 = [[MKTextSwitchCellModel alloc] init];
    cellModel5.index = 6;
    cellModel5.msg = @"Device property indicator";
    cellModel5.isOn = self.dataModel.devicePropertyIndicator;
    [self.section1List addObject:cellModel5];
    
    MKTextSwitchCellModel *cellModel6 = [[MKTextSwitchCellModel alloc] init];
    cellModel6.index = 7;
    cellModel6.msg = @"Switch status indicator";
    cellModel6.isOn = self.dataModel.switchStatusIndicator;
    ...
    cellModel7.isOn = self.dataModel.devicePropertyIndicator;
...
- (void)loadSubViews {
    ...
    self.defaultTitle = @"BXP-Device info payload";
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKInfoPayloadController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKInfoPayloadModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKInfoPayloadModel alloc] init];
    }
    return _dataModel;
}
