...
@interface MKCKUidPayloadController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKUidPayloadModel *dataModel;

@end

@implementation MKCKUidPayloadController

- (void)dealloc {
    NSLog(@"MKCKUidPayloadController销毁");
}
...
- (void)mk_textSwitchCellStatusChanged:(BOOL)isOn index:(NSInteger)index {
    ...
    if (index == 3) {
        //Namespace
        self.dataModel.namespaceID = isOn;
    ...
    if (index == 4) {
        //Instance
        self.dataModel.instanceID = isOn;
...
- (void)loadSection1Datas {
    ...
    MKTextSwitchCellModel *cellModel2 = [[MKTextSwitchCellModel alloc] init];
    cellModel2.index = 3;
    cellModel2.msg = @"Namespace";
    cellModel2.isOn = self.dataModel.namespaceID;
    [self.section1List addObject:cellModel2];
    
    MKTextSwitchCellModel *cellModel3 = [[MKTextSwitchCellModel alloc] init];
    cellModel3.index = 4;
    cellModel3.msg = @"Instance";
    cellModel3.isOn = self.dataModel.instanceID;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"Eddystone-UID payload";
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKUidPayloadController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKUidPayloadModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKUidPayloadModel alloc] init];
    }
    return _dataModel;
}
