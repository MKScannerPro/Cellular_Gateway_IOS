...
@interface MKCKBeaconPayloadController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKBeaconPayloadModel *dataModel;

@end

@implementation MKCKBeaconPayloadController

- (void)dealloc {
    NSLog(@"MKCKBeaconPayloadController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel1.index = 2;
    cellModel1.msg = @"UUID";
    cellModel1.isOn = self.dataModel.uuid;
    [self.section1List addObject:cellModel1];
    
    MKTextSwitchCellModel *cellModel2 = [[MKTextSwitchCellModel alloc] init];
    cellModel2.index = 3;
    cellModel2.msg = @"Major";
    cellModel2.isOn = self.dataModel.major;
    [self.section1List addObject:cellModel2];
    
    MKTextSwitchCellModel *cellModel3 = [[MKTextSwitchCellModel alloc] init];
    cellModel3.index = 4;
    cellModel3.msg = @"Minor";
    cellModel3.isOn = self.dataModel.minor;
    [self.section1List addObject:cellModel3];
    
    MKTextSwitchCellModel *cellModel4 = [[MKTextSwitchCellModel alloc] init];
    cellModel4.index = 5;
    cellModel4.msg = @"RSSI@1m";
    cellModel4.isOn = self.dataModel.rssi1m;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"iBeacon payload";
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKBeaconPayloadController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKBeaconPayloadModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKBeaconPayloadModel alloc] init];
    }
    return _dataModel;
}
