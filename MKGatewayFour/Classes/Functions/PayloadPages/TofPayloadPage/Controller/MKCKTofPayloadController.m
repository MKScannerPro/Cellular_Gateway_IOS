...
@interface MKCKTofPayloadController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKTofPayloadModel *dataModel;

@end

@implementation MKCKTofPayloadController

- (void)dealloc {
    NSLog(@"MKCKTofPayloadController销毁");
}
...
- (void)mk_textSwitchCellStatusChanged:(BOOL)isOn index:(NSInteger)index {
    ...
    if (index == 2) {
        ...
        self.dataModel.manufacturer = isOn;
    ...
    if (index == 5) {
        //Ranging distance
        self.dataModel.rangingDistance = isOn;
...
- (void)loadSection1Datas {
    MKTextSwitchCellModel *cellModel1 = [[MKTextSwitchCellModel alloc] init];
    cellModel1.index = 2;
    cellModel1.msg = @"Manufacturer vendor code";
    cellModel1.isOn = self.dataModel.manufacturer;
    ...
    cellModel3.index = 4;
    cellModel3.msg = @"User data";
    cellModel3.isOn = self.dataModel.userData;
    [self.section1List addObject:cellModel3];
    
    MKTextSwitchCellModel *cellModel4 = [[MKTextSwitchCellModel alloc] init];
    cellModel4.index = 5;
    cellModel4.msg = @"Ranging distance";
    cellModel4.isOn = self.dataModel.rangingDistance;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"MK TOF payload";
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKTofPayloadController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKTofPayloadModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKTofPayloadModel alloc] init];
    }
    return _dataModel;
}
