//
//  MKCKNanoBeaconPayloadController.m
...
@interface MKCKNanoBeaconPayloadController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKNanoBeaconPayloadModel *dataModel;

@end

@implementation MKCKNanoBeaconPayloadController

- (void)dealloc {
    NSLog(@"MKCKNanoBeaconPayloadController销毁");
}
...
- (void)mk_textSwitchCellStatusChanged:(BOOL)isOn index:(NSInteger)index {
    ...
    if (index == 3) {
        //Manufacture id
        self.dataModel.manufactureId = isOn;
    ...
    if (index == 5) {
        //Battery voltage
        self.dataModel.batteryVoltage = isOn;
    ...
    if (index == 8) {
        //Trigger status
        self.dataModel.triggerStatus = isOn;
...
- (void)loadSection1Datas {
    ...
    cellModel1.isOn = self.dataModel.deviceName;
    [self.section1List addObject:cellModel1];
    
    MKTextSwitchCellModel *cellModel2 = [[MKTextSwitchCellModel alloc] init];
    cellModel2.index = 3;
    cellModel2.msg = @"Manufacture id";
    cellModel2.isOn = self.dataModel.manufactureId;
    [self.section1List addObject:cellModel2];
    
    MKTextSwitchCellModel *cellModel3 = [[MKTextSwitchCellModel alloc] init];
    cellModel3.index = 4;
    cellModel3.msg = @"Adv type";
    cellModel3.isOn = self.dataModel.advType;
    [self.section1List addObject:cellModel3];
    
    MKTextSwitchCellModel *cellModel4 = [[MKTextSwitchCellModel alloc] init];
    cellModel4.index = 5;
    cellModel4.msg = @"Battery voltage";
    cellModel4.isOn = self.dataModel.batteryVoltage;
    ...
    cellModel6.index = 7;
    cellModel6.msg = @"SEC_CNT";
    cellModel6.isOn = self.dataModel.secCNT;
    [self.section1List addObject:cellModel6];
    
    MKTextSwitchCellModel *cellModel7 = [[MKTextSwitchCellModel alloc] init];
    cellModel7.index = 8;
    cellModel7.msg = @"Trigger status";
    cellModel7.isOn = self.dataModel.triggerStatus;
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"NanoBeacon info payload";
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKNanoBeaconPayloadController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKNanoBeaconPayloadModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKNanoBeaconPayloadModel alloc] init];
    }
    return _dataModel;
}
