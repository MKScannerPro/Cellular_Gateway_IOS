//
//  MKCKNetworkSettingsController.m
...
@interface MKCKNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKNetworkSettingsModel *dataModel;

@end

@implementation MKCKNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKCKNetworkSettingsController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel4.index = 3;
    cellModel4.msg = @"Connect timeout";
    cellModel4.textPlaceholder = @"30-600";
    cellModel4.textFieldType = mk_realNumberOnly;
    cellModel4.maxLength = 3;
    cellModel4.textFieldValue = self.dataModel.timeout;
    cellModel4.unit = @"Second";
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKNetworkSettingsController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
