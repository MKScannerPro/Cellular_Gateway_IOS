...
- (void)connectDeviceWithDataModel:(MKCKScanInfoCellModel *)scanDataModel {
    ...
    [[MKCKConnectModel shared] connectDevice:scanDataModel.peripheral password:(scanDataModel.needPassword ? password : @"") deviceName:scanDataModel.deviceName deviceType:[scanDataModel.deviceType integerValue] sucBlock:^{
