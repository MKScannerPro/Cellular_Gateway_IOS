...
@interface MKCKSyncTimeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCKSyncTimeModel *dataModel;

@end

@implementation MKCKSyncTimeController

- (void)dealloc {
    NSLog(@"MKCKSyncTimeController销毁");
}
...
- (void)mk_deviceTextCellValueChanged:(NSInteger)index textValue:(NSString *)value {
    ...
    if (index == 1) {
        //NTP Server
        self.dataModel.ntpServer = value;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayFour", @"MKCKSyncTimeController", @"ck_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCKSyncTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCKSyncTimeModel alloc] init];
    }
    return _dataModel;
}
