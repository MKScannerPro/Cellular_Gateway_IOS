...
@interface MKCKDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKCKDFUModule

- (void)dealloc{
    NSLog(@"MKCKDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKCKCentralManager shared].peripheral];
}
