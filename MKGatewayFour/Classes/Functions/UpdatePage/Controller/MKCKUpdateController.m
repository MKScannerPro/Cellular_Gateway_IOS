...
@interface MKCKUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCKDFUModule *dfuModule;
...
@implementation MKCKUpdateController

- (void)dealloc {
    NSLog(@"MKCKUpdateController销毁");
...
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ck_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKCKCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ck_centralDeallocNotification" object:nil];
...
- (MKCKDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKCKDFUModule alloc] init];
    }
    return _dfuModule;
}
