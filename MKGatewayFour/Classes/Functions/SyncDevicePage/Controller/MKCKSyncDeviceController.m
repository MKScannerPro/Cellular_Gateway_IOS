...
- (void)syncButtonPressed {
    ...
    [[MKNormalService share] addScannerProDevicesToCloud:uploadList isHome:[MKCKUserLoginManager shared].isHome token:self.token sucBlock:^(id returnData) {
