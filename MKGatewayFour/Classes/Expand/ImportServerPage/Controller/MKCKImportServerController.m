...
@interface MKCKImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCKImportServerController

- (void)dealloc {
    NSLog(@"MKCKImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(ck_selectedServerParams:)]) {
        [self.delegate ck_selectedServerParams:model.leftMsg];
    }
