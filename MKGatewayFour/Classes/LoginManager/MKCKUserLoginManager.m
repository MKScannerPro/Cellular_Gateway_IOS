...
static MKCKUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKCKUserLoginManager ()
...
+ (MKCKUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKCKUserLoginManager new];
        }
    });
    return loginManager;
}
